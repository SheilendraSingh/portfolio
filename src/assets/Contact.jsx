...
export default function Contacts() {
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-center min-h-screen bg-[#1a0b2e] text-[#e0e0e0]  px-8">
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row gap-12">
          {/* Left Side: Get in Touch & Contact Info */}
          ...
          <div className="md:w-1/3 space-y-6 ml-28">
            <div className="mb-20">
              ...
              <p className="text-[#b0a8c4]">
                ...
                Discussing New Projects, Creative Ideas or New Opportunities to
